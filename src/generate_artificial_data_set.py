...
template = Template(
    ...
    font=ImageFont.truetype("../font/LIGUOFU.ttf", size=100),
    line_spacing=150,
    fill=0,  # 字体“颜色”
    left_margin=0,
    top_margin=0,
...
# output_path = "/Users/steve235lab/Documents/DataSets/artificial_CN_handwriting/col_client/"       # Path of OS X
output_path = "G:/artificial_CN_handwriting/col_client/test/"      # Path of Windows
